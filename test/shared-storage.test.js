...
test("requires Supabase configuration", async () => {
  clearSupabaseConfig();
  await assert.rejects(() => loadSharedBookings(), /Supabase is not configured/);
});

test("surfaces Supabase network failures", async () => {
  clearSupabaseConfig();
